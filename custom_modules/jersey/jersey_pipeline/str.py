...
def run_inference_tracklab(model, crops, img_size):
    results = []
    for item in crops:
        image = item["img"]
...
def set_temperature(model, data_root, img_size):
    ...
    after_temperature_ece = ece_criterion(
        temperature_scale(logits, temperature), labels
    ).item()
...
def main():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Evaluate on standard benchmark datasets",
    )
    parser.add_argument(
        "--new",
        action="store_true",
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=True,
        help="Evaluate on custom personal datasets",
    )
    parser.add_argument(
        "--rotation",
        type=int,
